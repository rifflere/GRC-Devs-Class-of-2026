const teachers = [
  {
    ...
    skills: ['MVC Framework', 'Express.js', 'REST APIs', 'Routing & Middleware', 'Pug Templating', 'Authentication', 'npm'],
  ...
  },
  {
    ...
    skills: ['Java', 'Data Structures', 'Algorithms', 'Big-O Analysis','Systems Programming', 'Problem-Solving', 'Technical Interview Prep', 'Project-Based Learning'],
  ...
  },
  {
    ...
    skills: ['HTML/CSS', 'Responsive Design', 'UI/UX Principles', 'Web Development Frameworks', 'Agile Metholodologies', 'Real-World Project Delivery'],
  ...
  },
  {
    ...
    skills: ['React', 'Component-Based Architecture', 'Prps & State Management', 'React Hooks', 'Frontend Development'],
  ...
  },
  {
    ...
    skills: ['CI/CD (GitHub Actions)', 'DigitalOcean', 'AI Fundamentals', 'Machine Learning', 'SQL', 'Cloud Deployment', 'Digital Ocean'],
  ...
  },
  {
    ...
    skills: ['Colab Notebooks', 'Python', 'Pandas', 'Matplotlib', 'Decision Trees', 'AI/ML Concepts', 'Data Analysis', 'Growth Mindset'],
